                        ...
                        @foreach ($roles as $key => $role)
                            ...
                            <tr>
                                ...
                                <td class="width-22-rem text-left">
                                    <a href="{{ route('admin.user.role.permission.role',[$role->id]) }}" class="btn btn-success btn-sm"><i class="fa fa-user-graduate"></i> دسترسی ها</a>
                                    ...
                                    <form class="d-inline" action="{{ route('admin.user.role.destroy',[$role->id]) }}" method="post">
                                        @csrf
                                        {{ method_field('delete') }}
                                        <button class="delete btn btn-danger btn-sm" type="submit"><i class="fa fa-trash-alt"></i> حذف</button>
                                    </form>
                                </td>
                            </tr>
