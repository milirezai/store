...
class CategoryController extends Controller
{
    ...
    {
        $productCategories = ProductCategory::orderBy('id', 'desc')->simplePaginate(15);
    ...
    public function destroy(ProductCategory $productCategory)
    {
        ...
        return redirect()->route('admin.market.category.index')->with('swal-error', 'دسته بندی شما با موفقیت حذف شد');
    }
